...
try:
    movies = pickle.load(open('C:/Users/Pavan/Desktop/Recommender System/movie_list.pkl', 'rb'))
    similarity = pickle.load(open('C:/Users/Pavan/Desktop/Recommender System/similarity.pkl', 'rb'))
except Exception as e:
